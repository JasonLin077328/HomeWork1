namespace HomeWork1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶資料總攬Repository Get客戶資料總攬Repository()
		{
			var repository = new 客戶資料總攬Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶資料總攬Repository Get客戶資料總攬Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶資料總攬Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
